...
#define BSEC_MAX_PROPERTY_BLOB_SIZE  (2001)     /*!< Maximum size (in bytes) of the data blobs returned by bsec_get_configuration() */
#define BSEC_MAX_STATE_BLOB_SIZE     (255)        /*!< Maximum size (in bytes) of the data blobs returned by bsec_get_state()*/
